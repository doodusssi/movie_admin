    ...
    <main>
        ...
        <table>
            ...
            <tbody>
                <c:if test="${list.size()==0}">
                    <tr>
                        <td colspan="10">
                            <c:if test="${keyword != null}">검색어 "${keyword}"에 해당하는 정보가 없습니다.</c:if> 
                        </td>
                    </tr>
                </c:if>
                ...
                <tr>
                    ...
                    <td>
                        <div class="poster_img" style="background-image: url('/images/movie/${item.poster_img}');
        ...
        <div class="pager_area">
            <c:forEach begin="1" end="${pageCount}" var="i">
                ...
                <c:if test="${country == null}">
                    <a href="/movie/list?page=${i}&keyword=${keyword}=${keyword}">${i}</a>
                </c:if>
            </c:forEach>
        </div>
    </main>
